    ...
    def handle(self, *args, **kwargs):
        projects = [
            {
                ...
                "is_public": False,
                "alt": "99%",
                "icon_url":"https://website-portfolio-bucket.s3.eu-west-2.amazonaws.com/icons/99pct.jpg",
            ...
            },
            {
                ...
                "is_public": True,
                "alt": "HoC",
                "icon_url":"https://website-portfolio-bucket.s3.eu-west-2.amazonaws.com/icons/Hoc-1.png",
            ...
            },
            {
                ...
                "is_public": False,
                "alt": "Ardent",
                "icon_url":"https://website-portfolio-bucket.s3.eu-west-2.amazonaws.com/icons/ardentAvatar.png",
            ...
            },
            {
                ...
                "is_public": False,
                "alt": "ETF's",
                "icon_url":"https://website-portfolio-bucket.s3.eu-west-2.amazonaws.com/icons/investments.jpg",
        ...
        for project_data in projects:
            project, created = Project.objects.get_or_create(
                ...
                icon_url=project_data["icon_url"],
                alt=project_data["alt"],
